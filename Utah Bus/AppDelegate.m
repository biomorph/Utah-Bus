...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UTAViewController *routeController = (UTAViewController *)navigationController.topViewController;
    routeController.managedObjectContext = self.managedObjectContext;
    return YES;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"UTAGTFS" withExtension:@"momd"];
